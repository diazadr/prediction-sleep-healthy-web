...
class SleepInput(BaseModel):
    ...
    denyut_jantung: float = Field(..., ge=0, le=250, description="Detak jantung per menit")
    langkah_harian: float = Field(..., ge=0, le=100000, description="Jumlah langkah harian")
    sistolik: float = Field(..., ge=50, le=250, description="Tekanan darah sistolik")
    diastolik: float = Field(..., ge=30, le=150, description="Tekanan darah diastolik")
